...
<h4 align="center" style="padding-top: 20px; padding-bottom: 20px;"><b>개 인 정 보    약 관</b></h4>
...
(주)셰어베르니는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.

<b style="font-size: 12px;">■ 수집하는 개인정보 항목 및 수집방법</b>
가. 수집하는 개인정보의 항목
...
<b style="font-size: 12px;">■ 개인정보의 수집 및 이용목적</b>
...
<b style="font-size: 12px;">■ 개인정보의 보유 및 이용기간</b>
...
<b style="font-size: 12px;">■ 개인정보의 파기절차 및 방법</b>
...
<b style="font-size: 12px;">■ 개인정보 제공</b>
회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
o 이용자들이 사전에 동의한 경우
o 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우

<b style="font-size: 12px;">■ 수집한 개인정보의 위탁</b>
...
<b style="font-size: 12px;">■ 이용자 및 법정대리인의 권리와 그 행사방법</b>
o 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.
o 이용자들의 개인정보 조회,수정을 위해서는 "개인정보변경"(또는 "회원정보수정" 등)을 가입해지(동의철회)를 위해서는 "회원탈퇴"를 클릭하여 본인 확인 절차를 거치신 후 
...
o 회사는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 "회사가 수집하는 개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 
처리하고 있습니다.

<b style="font-size: 12px;">■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</b>
회사는 귀하의 정보를 수시로 저장하고 찾아내는 "쿠키(cookie)" 등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 
...
2. 귀하는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 귀하는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 
   쿠키의 저장을 거부할 수도 있습니다.
o 쿠키 설정 거부 방법
1. 쿠키 설정을 거부하는 방법으로는 회원님이 사용하시는 웹 브라우저의 옵션을 선택함으로써 모든 쿠키를 허용하거나 쿠키를 저장할 때마다 확인을 거치거나, 
   모든 쿠키의 저장을 거부할 수 있습니다.
2. 설정방법 예(인터넷 익스플로어의 경우) : 웹 브라우저 상단의 도구 > 인터넷 옵션 > 개인정보
3. 단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을 수 있습니다.

<b style="font-size: 12px;">■ 개인정보에 관한 민원서비스</b>
회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.
o 개인정보관리담당자
성명 : 이초희
소속 : 민원팀
전화번호 : 02-777-7771
이메일 : dlchgml@naver.com

o 개인정보관리책임자
성명 : 강은지
소속 : 책임팀
전화번호 : 02-777-7772
이메일 : rkddmswl@naver.com
